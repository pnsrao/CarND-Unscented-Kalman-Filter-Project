...
UKF::UKF() {
  ...
  */
  ...
  n_aug_ = 7;
  lambda_ = 3 - n_aug_;
  // Provide an appropriate value for linear  and angular acceleration
  std_a_ = 1;
  std_yawdd_ = M_PI/8;
...
void UKF::ProcessMeasurement(MeasurementPackage measurement_package) {
  ...
  */
   ...
   ****************************************************************************/
  if (!is_initialized_) {
    P_.setIdentity(); // Default initialization of covariance.
    if (measurement_package.sensor_type_ == MeasurementPackage::RADAR) {
      ...
      */
      ...
      float rhodot = measurement_package.raw_measurements_[2];
      x_ << rho*cos(phi), rho*sin(phi), 0,0,0; //rhodot*cos(phi), rhodot*sin(phi);
    }
      ...
      // Initialize with better values in case Lidar is the first measurement
...
void UKF::UpdateLidar(MeasurementPackage measurement_package) {
  ...
  */
  ...
  VectorXd y = measurement_package.raw_measurements_ - z_pred;
  ...
  // Print out the NIS for Laser. It will be post processed later
  // cout<<"NISL "<<nis<<" ";
  x_ = x_ + (K * y);
  long x_size = x_.size();
...
void UKF::UpdateRadar(MeasurementPackage measurement_package) {
  ...
  */
  ...
  //Print the NIS for Radar. It will be postprocessed later.
  //cout<<"NISR "<<nis<<" ";
